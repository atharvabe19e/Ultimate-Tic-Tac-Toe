...
<SafeAreaView style={styles.mainContainer}>
 ...
 <TouchableOpacity style={[styles.cell,styles.cellR]} onPress={()=>markPosition(3)}>
   {markers[0][3] === 'X' && <Image source={require('../assets/img/cross.png')} style={styles.icon} />}
   {markers[0][3] === 'O' && <Image source={require('../assets/img/zero.png')} style={styles.icon} />}
 </TouchableOpacity>

 {/* Mid Mid Cell */}
 <TouchableOpacity style={styles.cell} onPress={()=>markPosition(4)}>
   {markers[0][4] === 'X' && <Image source={require('../assets/img/cross.png')} style={styles.icon} />}
   {markers[0][4] === 'O' && <Image source={require('../assets/img/zero.png')} style={styles.icon} />}
 </TouchableOpacity>

 {/* Mid Right Cell */}
 <TouchableOpacity style={[styles.cell,styles.cellL]} onPress={()=>markPosition(5)}>
   {markers[0][5] === 'X' && <Image source={require('../assets/img/cross.png')} style={styles.icon} />}
   {markers[0][5] === 'O' && <Image source={require('../assets/img/zero.png')} style={styles.icon} />}
 </TouchableOpacity>

 {/* Bottom Left Cell */}
 <TouchableOpacity style={[styles.cell,styles.cellR,styles.cellU]} onPress={()=>markPosition(6)}>
   {markers[0][6] === 'X' && <Image source={require('../assets/img/cross.png')} style={styles.icon} />}
   {markers[0][6] === 'O' && <Image source={require('../assets/img/zero.png')} style={styles.icon} />}
 </TouchableOpacity>

 {/* Bottom Mid Cell */}
 <TouchableOpacity style={[styles.cell,styles.cellU]} onPress={()=>markPosition(7)}>
   {markers[0][7] === 'X' && <Image source={require('../assets/img/cross.png')} style={styles.icon} />}
   {markers[0][7] === 'O' && <Image source={require('../assets/img/zero.png')} style={styles.icon} />}
 </TouchableOpacity>

 {/* Bottom Right Cell */}
 <TouchableOpacity style={[styles.cell,styles.cellL,styles.cellU]} onPress={()=>markPosition(8)}>
   {markers[0][8] === 'X' && <Image source={require('../assets/img/cross.png')} style={styles.icon} />}
   {markers[0][8] === 'O' && <Image source={require('../assets/img/zero.png')} style={styles.icon} />}
 </TouchableOpacity>
